Vagrant.configure("2") do |config|
	...
	config.vm.define "dc1" do |dc1|
	  dc1.vm.box = "bandit145/server_2016"
	...
	config.vm.define "dc2" do |dc2|
	  dc2.vm.box = "bandit145/server_2016"
	...
	config.vm.define "server1" do |server1|
	  server1.vm.box = "bandit145/server_2016"
	...
	config.vm.define "server2" do |server2|
	  server2.vm.box = "bandit145/server_2016"
	...
	config.vm.define "ansible_server" do |ansible|
		...
		ansible.vm.provision "shell", inline: "sudo pip install ansible==2.5.5 pywinrm"
